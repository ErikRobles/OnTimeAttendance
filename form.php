...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="index.html"><img src="img/clock.svg" class="clock" style="margin-right: 5px; margin-top: ; width: 100px;"></img><span class="bigFont">O</span>n Time Attendance</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="#"><i class="fa fa-home" style="margin-right: 5px;"></i>Inicio <span class="sr-only"></span></a>
        </li>
        <li class="nav-item active">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="form.php"><i class="fa fa-user-plus" aria-hidden="true" style="margin-right: 5px;"></i>Registrar</a>
            <a class="dropdown-item" href="login.html"><i class="fa fa-sign-in" aria-hidden="true" style="margin-right: 5px;"></i>Log-In</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="#"><i class="fa fa-server" aria-hidden="true" style="margin-right: 5px;"></i>Productos</a>
          </div>
        </li>
        </ul>
      </div>
